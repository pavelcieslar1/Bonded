    ...
    public partial class start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionnaireCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelationshitpStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AstralSign = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionnaireQuestions_QuestionnaireCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserHobby_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOccupation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserOccupation_Occupations_OccupationId",
                        column: x => x.OccupationId,
                        principalTable: "Occupations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOccupation_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserQuestions_QuestionnaireAnswers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "QuestionnaireAnswers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserQuestions_QuestionnaireQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuestionnaireQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserQuestions_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireQuestions_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHobby_UserProfileId",
                table: "UserHobby",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_UserOccupation_OccupationId",
                table: "UserOccupation",
                column: "OccupationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserOccupation_UserProfileId",
                table: "UserOccupation",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuestions_UserProfileId",
                table: "UserQuestions",
                column: "UserProfileId");
        }
