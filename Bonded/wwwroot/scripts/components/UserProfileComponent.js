...
export function renderUserProfile(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        <div class="profile-left-col mb-2">
            <div class="profile-images-content glass-card">
                ...
                <div id="profile-header" class="profile-header" style="background-image: url(${(_a = userProfile.profileImageUrl) !== null && _a !== void 0 ? _a : `https://placehold.co/60x60/87CEEB/ffffff?text=${userProfile.firstName[0] + userProfile.lastName[0]}`});">
                ...
                <div class="profile-content">
                  <div class="profile-rating-wrapper position-relative">
                      ...
                      <p class="profile-age-location mb-3">${getBirthDate(userProfile.dateOfBirth)} let, ${userProfile.city}</p>
                      <div id="resultBtn" class="rating-badge position-absolute top-50 end-0 translate-middle-y mt-5" style="display:${myProfile ? "none" : "initial"}"><i class="bi bi-heart-fill xl-icon ${user.roles.some((role) => role === "Admin" || role === "Premium") ? "gemini-text heart-pulse" : "text-color-1 heart-pulse"} "><span id="resultText" class="position-absolute top-50 start-50 translate-middle fs-4 text-light fw-light text-center user-select-none"></span></i></div>
                  </div>
        ...
        <div class="profile-right-col ">
            ...
            .join("")}
                ...
                ${(_b = userProfile.categoryScores) === null || _b === void 0 ? void 0 : _b.map((cat) => `
                    <div class="progress-item mb-3 align-items-center "> 
                        <p class="progress-label fw-light px-2">${cat.categoryName}</p>
                        <div class="progress-bar-container">
                          <div class="progress-bar-fill" style="width: ${(cat.points / cat.maxPoints) * 100}%;">
                          </div>
                        </div>
                    </div>
  ...
  `);
        ...
        if (startChatButton) {
            startChatButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                const recipientId = startChatButton.getAttribute("data-user-id");
                if (!recipientId)
                    return;
                const chatId = yield startChat(recipientId);
                if (chatId) {
        ...
        if (showMainPageComponent) {
            showMainPageComponent.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (showMatchButton) {
            showMatchButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                if (user.roles.some((role) => role === "Admin" || role === "Premium")) {
                    // @ts-ignore
        ...
        `);
                    ...
                    try {
                        const data = yield getMatch(userProfile.id.toString(), localStorage.getItem("userId"));
                        if (data === 0 || data === null) {
        ...
        const fileInput = document.getElementById("uploaded-image-url");
        ...
        uploadImage === null || uploadImage === void 0 ? void 0 : uploadImage.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        `);
            ...
            try {
                const res = yield fetch("https://api.cloudinary.com/v1_1/dczkmh44m/image/upload", {
                    method: "POST",
                    body: formData,
                });
                if (!res.ok)
                ...
                yield fetch("/api/user/profile-photo", {
                    method: "POST",
        ...
        function optimizeImage(originalUrl) {
        ...
        function getBirthDate(datumNarozeni, dnesniDatum) {
            let narozky;
