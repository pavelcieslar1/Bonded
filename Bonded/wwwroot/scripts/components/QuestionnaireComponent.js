...
export function renderQuestionnaire() {
    return __awaiter(this, void 0, void 0, function* () {
        function loadQuestions() {
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield fetch("/api/questionnaire/questions");
                if (!res.ok) {
        ...
        <div class="px-2 mb-3 mt-2">
          <div class="profile-actions">
            <button id="backBtn" class="btn btn-light rounded-circle my-3 mx-2"><i class="bi bi-chevron-left"></i></button>
              ...
              <div class="row my-3">
                ...
                .map((ans, i) => `
                          <button type="button"
                          class="question-answer glass-card btn w-100 my-1 fw-normal py-1${selected === i ? " active" : ""}"
                          data-index="${i}"
                          style="background:${selected === i ? "#5c4d7d" : "rgba(255, 255, 255, 0.4)"};color:${selected === i ? "#fff" : "#5c4d7d"};border:0px solid rgba(255, 255, 255, 0.2);border-radius:16px;font-weight:500;font-size:1.1rem;transition:.17s;text-align:left;word-wrap: break-word;white-space: normal;">
                          ${ans.label}
                          </button>`)
                .join("")}
                      </div>
          ...
          <!-- Tlačítko další otázka -->
              <div class="text-center m-3">
                  <button id="nextBtn" class="my-btn-3 mt-1" ${selected === null ? "disabled" : ""}>
            ...
            nextBtn === null || nextBtn === void 0 ? void 0 : nextBtn.addEventListener("click", () => {
                ...
                if (selected !== null) {
                    ...
                    if (current < questions.length - 1) {
                        current++;
                        selected = ((_a = userAnswers[current]) === null || _a === void 0 ? void 0 : _a.answerId)
