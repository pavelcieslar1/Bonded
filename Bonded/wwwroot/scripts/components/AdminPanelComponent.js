...
export function renderAdminPanel() {
    ...
    `);
        ...
        function fetchUsers(name, email, id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (id)
                    params.append('id', id);
                const res = yield fetch('/api/user/list?' + params.toString());
                if (!res.ok)
                    console.log('Chyba načítání');
        ...
        function renderUserTable(users) {
            ...
            document.querySelectorAll(".edit-user-btn").forEach(btn => {
                btn.addEventListener("click", (e) => {
                    ...
                    showEditModal(t.getAttribute("data-id"), t.getAttribute("data-email"), t.getAttribute("data-role"));
                });
            });
        }
        // 3. Ovládání filtru
        (_a = document.getElementById("searchBtn")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            const name = document.getElementById("searchName").value.trim();
            const email = document.getElementById("searchEmail").value.trim();
            const id = document.getElementById("searchId").value.trim();
            const users = yield fetchUsers(name, email, id);
            renderUserTable(users);
        }));
        // 4. Modal logika
        function showEditModal(id, email, role) {
        ...
        // 5. Uložení změn
        (_b = document.getElementById("modalSaveBtn")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const id = document.getElementById("modalUserId").value;
            const role = document.getElementById("modalRole").value;
            yield fetch("/api/role/assign", {
                method: "POST",
            ...
            (_b = bootstrap.Modal.getInstance(document.getElementById('editUserModal'))) === null || _b === void 0 ? void 0 : _b.hide();
        }));
        // 6. Smazání účtu
        (_c = document.getElementById("modalDeleteBtn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const id = document.getElementById("modalUserId").value;
            ...
            confirmModal.show();
            // Skrýt edit modal
            (_a = bootstrap.Modal.getInstance(document.getElementById('editUserModal'))) === null || _a === void 0 ? void 0 : _a.hide();
        }));
        // 7. Potvrzení smazání
        (_d = document.getElementById("confirmDeleteBtn")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const id = document.getElementById("modalUserId").value;
            try {
                const response = yield fetch(`/api/user/delete/${id}`, {
                    method: "DELETE",
                    credentials: "include"
                });
                if (response.ok) {
            ...
            (_b = bootstrap.Modal.getInstance(document.getElementById('deleteConfirmModal'))) === null || _b === void 0 ? void 0 : _b.hide();
        }));
    });
}
