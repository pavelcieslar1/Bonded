...
export function renderMainPage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        localStorage.setItem("userId", (_a = userProfile.id) === null || _a === void 0 ? void 0 : _a.toString());
        const globalFeedHtmlString = yield renderGlobalFeedTile();
        const peopleAroundTile = yield renderPeopleAroundTile();
        const horoscopeTile = yield renderHoroscopeTile();
        const chatlist = yield renderChatListTile();
        // @ts-ignore
  ...
  `);
        ...
        if (showFilterButton) {
            showFilterButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (showQuestionnerButton) {
            showQuestionnerButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (showPeopleAroundButton) {
            showPeopleAroundButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (showGlobalFeedButton) {
            showGlobalFeedButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (globalSearchButton) {
            globalSearchButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
    ...
    `);
      ...
      `);
        ...
        logoutBtn === null || logoutBtn === void 0 ? void 0 : logoutBtn.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
            e.preventDefault();
            const res = yield fetch("/api/account/logout", {
                method: "POST",
                credentials: "include"
            });
            if (res.ok) {
        ...
        const userZodiacSign = userProfile.astralSign;
        function toggleHoroscopeLoading(isLoading) {
            const loadingSpinner = document.getElementById("horoscopeLoading");
            const showHoroscopeBtn = document.getElementById("showHoroscopeBtn");
            const horoscopeTextElement = document.getElementById("horoscopeText");
            const horoscopeSignElement = document.getElementById("horoscopeSign");
            if (isLoading) {
                if (loadingSpinner)
                    loadingSpinner.style.display = "block";
                if (showHoroscopeBtn)
                    showHoroscopeBtn.disabled = true;
                if (horoscopeTextElement)
                    horoscopeTextElement.textContent = ""; // Clears previous text
                ...
                if (showHoroscopeBtn)
                    showHoroscopeBtn.disabled = false;
            }
        }
        ...
        if (showHoroscopeButton) {
            showHoroscopeButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const horoscope = (yield getHoroscope(userZodiacSign)).toString();
                    horoscopeTextElement.textContent = horoscope;
                }
                catch (error) {
                    console.error("Chyba volání Gemini API pro horoskop:", error);
                    if (horoscopeTextElement)
                        horoscopeTextElement.textContent = "Nastala chyba při načítání horoskopu. Zkuste to prosím později.";
                }
                finally {
                    toggleHoroscopeLoading(false);
                }
